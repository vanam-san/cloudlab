...
function checkLatestRelease(){
    ...
    # LOCAL FIX: upstream pattern '"tag_name": "' requires a space after the
    # colon, but this environment receives compact JSON ('"tag_name":"..."'),
    # so the check always failed. Tolerate optional whitespace instead.
